...
private slots:
    ...
    void ParseAndPopulateSTARSuntHistoryTable(QString Response);
    ...
    QString BuySTARS(QString OrderType, double Quantity, double Rate);
    QString SellSTARS(QString OrderType, double Quantity, double Rate);
